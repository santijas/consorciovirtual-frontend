  ...
  return (
    ...
    >
      ...
      <List>
        ...
        { user.esAdmin() &&
          <ListItem className={classes.softHover} button key="Usuarios" onClick={() => handleSelectMenu("/usuarios")}>
          ...
          <ListItem className={classes.softHover} button key="Departamentos" onClick={() => handleSelectMenu("/departamentos")}>
          ...
          <ListItem className={classes.softHover} button key="Anuncios" onClick={() => handleSelectMenu("/anuncios")}>
          ...
          <ListItem className={classes.softHover} button key="Reclamos" onClick={() => handleSelectMenu("/reclamos")}>
          ...
          <ListItem className={classes.softHover} button key="Solicitudes técnicas" onClick={() => handleSelectMenu("/solicitudes")}>
        ...
        { user.esPropietario() &&
          <ListItem className={classes.softHover} button key="Inquilinos" onClick={() => handleSelectMenu("/inquilinos")}>
          ...
          <ListItem className={classes.softHover} button key="Gastos" onClick={() => handleSelectMenu("/gastos")}>
          ...
          <ListItem className={classes.softHover} button key="Expensas" onClick={() => handleSelectMenu("/expensas")}>
          ...
          <ListItem className={classes.softHover} button key="Documentos" onClick={() => handleSelectMenu("/documentos")}>
